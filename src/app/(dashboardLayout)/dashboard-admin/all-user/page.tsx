...
//   const providers = data.filter((u: any) => u.role === "PROVIDER").length;
//   const customers = data.filter((u: any) => u.role === "CUSTOMER").length;
...
//                     <TableCell>
//                       <Badge
//                         className={`border-0 bg-gray-700 dark:bg-gray-200`}
//                       >
//                         {user.role}
//                       </Badge>
//                     </TableCell>
...
import { User, CalendarDays, Mail, Shield } from "lucide-react";
import Link from "next/link";
import { UserStatusToggle } from "@/components/modules/adminDashboard/userStatusToggle";
